...
export default function UserList() {
  ...
  return (
    <>
      <Helmet>
        <title>Trainers List | {config.appName} </title>
      </Helmet>
      <div className='container'>
        <div className='page'>
          <div className='page-heading'>
            <h1>Trainers List</h1>
            <span>
              <Link to="/"> Dashboard </Link> / Trainers List
            </span>
          </div>
                    ...
                    <div className='col-lg-3 col-md-3 col-sm-6 col-12'>
                      <div className="p-2">
                        <div className="input-group p-4">
                          <Link className="btn btn-success" to="/user/manage"> <FontAwesomeIcon icon="fa-solid fa-plus" ></FontAwesomeIcon> Add Trainer </Link>
                        </div>
                      </div>
                    </div>
                  </div>
