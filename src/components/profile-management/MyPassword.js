...
export default function MyPassword() {
  ...
  const saveUser = async (event) => {
    ...
    if (!oldPassword) {
      setAppError(true);
      setAppErrorTitle("Error");
      setAppErrorMessage("Please enter your old password");
      setAppErrorMode("error");
      return;
    }
                ...
                <div className='form'>
                  <div className='row'>
                    <div className='col-12'>
                      <div className='mb-3'>
                        {role === "admin" ? (
                          <h5>Admin Name : {name} [  Mobile : {mobile} ] </h5>
                        ) : (
                      ...
                      <div className='row'>
                        <div className='col-lg-4 col-md-4 col-sm-6 col-12'>
                          <div className="mb-3 position-relative">
                            ...
                            />
                            <i
                              className={`ri-${showOldPassword ? 'eye-off-line' : 'eye-line'} position-absolute`}
