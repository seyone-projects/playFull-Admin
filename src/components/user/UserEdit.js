                                ...
                                <div className='form'>
                                    <form onSubmit={saveUser} encType='multipart/form-data'>
                                        <div className='row'>
                                            ...
                                            <div className='col-lg-4 col-md-6 col-sm-6 col-12'>
                                                <div className="mb-3">
                                                    <label className="form-label"> {role === "student" ? "Student Mobile" : "Trainer Mobile"}</label>
                                                    <input className='form-control' type='number' value={mobile} onChange={(e) => setMobile(e.target.value)} />
                                                </div>
                                            </div>
                                            <div className='col-lg-4 col-md-4 col-sm-6 col-12'>
                                                <div className="mb-3">
                                                    <label className="form-label"> {role === "student" ? "Student Email" : "Trainer Email"}</label>
                                                    <input className='form-control' type='email' value={email} onChange={(e) => setEmail(e.target.value)} />
                                                </div>
                                            </div>
                                            <div className='col-lg-4 col-md-6 col-sm-6 col-12'>
                                                <div className="mb-3">
                                                    <label className="form-label"> {role === "student" ? "Student Whatsapp" : "Trainer Whatsapp"}</label>
                                            ...
                                            <div className='col-12 text-end'>
                                                <div className="mb-3">
                                                    ...
                                                    <button type='submit' className='btn btn-success-app btn-md'>
                                                        ...
                                                        {user === null
                                                            ? ` Add ${role === 'student' ? 'Student' : 'Trainer'}`
                                                            : ` Update ${user?.role === 'student' ? 'Student' : 'Trainer'}`}
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
