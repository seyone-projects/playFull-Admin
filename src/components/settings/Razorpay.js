            ...
            <div className='container'>
                <div className='page'>
                    <div className='page-heading'>
                        <h1>Razorpay</h1>
                        <span>
                            <Link to="/"> Dashboard </Link> / Razorpay
                        </span>
                    </div>
                                        ...
                                        <div className='row'>
                                            ...
                                            <div className='col-12 text-end'>
                                                <div className="mb-3">
                                                    ...
                                                    &nbsp;&nbsp;
                                                    <button type='submit' className='btn btn-success-app btn-md'> <i className="ri-check-fill"></i> Save Razorpay </button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
