                ...
                <ul className='sidebar-nav' id='sidebar-nav'>
                    ...
                    <li className='nav-item'>
                        ...
                        <ul id='paymentreports-nav' className='nav-content collapse' data-bs-parent="#sidebar-nav">
                            ...
                            <li>
                                <Link to='/report/student/search/payment/'>
                                    <i className='bi bi-arrow-right'></i>
                    ...
                    <hr></hr>
                    <li className='nav-item'>
                        <Link className='nav-link collapsed' data-bs-target="#page-nav" data-bs-toggle="collapse" to='#'>
                            <i className="bi bi-info-circle"></i>
                            <span>Pages</span>
                            <i className='bi bi-chevron-down ms-auto'></i>
                        </Link>
                        <ul id='page-nav' className='nav-content collapse' data-bs-parent="#sidebar-nav">
                            <li>
                                <Link to='/page/manage'>
                                    <i className='bi bi-arrow-right'></i>
                                    <span>New Page</span>
